            ...
            <div id="consulta2">
                ...
                if($_SERVER['REQUEST_METHOD']==='POST')
                {
                    ...
                    if($resultado->num_rows>0)
                    {
                        ...
                        {
                            echo $fila->apre_id."<br>".$fila->apre_tipoid."<br>".$fila->apre_numid."<br>".$fila->apre_nombres."<br>".$fila->apre_apellidos."<br>".$fila->apre_direccion."<br>".$fila->apre_telefono."<br>".$fila->apre_ficha." "."<br>";
                        }
                    }
                    else{
